    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-[#2a0b0f] to-[#1a0507] flex items-center justify-center p-4">
        ...
        <div className="w-full max-w-md mx-auto">
          {/* Payment Modal Card */}
          <div className={`${styles.paymentCard} relative rounded-3xl shadow-2xl border border-yellow-500/20 overflow-hidden 
            ...
            <div className="max-h-[calc(100vh-200px)] overflow-y-auto custom-scrollbar px-6 pb-6">
              ...
              <div className="mb-6">
                <h3 className="text-white text-sm mb-4">Choisissez votre mode de paiement</h3>
                  ...
                  {selectedPaymentMethod === 'card' && (
                    <div className="space-y-3 pl-8 mt-3">
                      ...
                      <div className="flex items-center space-x-2 pt-2">
                        ...
                        <span className="text-white/50 text-xs">Paiement sécurisé par Stripe</span>
                      </div>
                    </div>
                  )}
                </ActionButtonCard>
                ...
                <ActionButtonCard
                  ...
                  label="Paiement express"
                  description="Carte **** 8801"
                  ...
                  {selectedPaymentMethod === 'paypal' && (
                    <div className="pl-8 mt-2">
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-white/50 text-xs">Authentification avec Face ID biométrique</span>
                      </div>
                      <p className="text-white/40 text-xs mt-2">Paiement en un tap sécurisé</p>
                    </div>
                  )}
                </ActionButtonCard>
                ...
                <ActionButtonCard
                  ...
                  description="Recevez un lien PayPal pour finaliser"
              ...
              <div className="flex items-start space-x-2 mb-6">
                ...
                <p className="text-white/50 text-xs leading-relaxed">
                  J'accepte les{' '}
                  <button className="text-yellow-500 underline">conditions générales</button>
                  {' '}de vente
                </p>
              </div>
              ...
              <ActionButtonCard
                ...
                showArrow={false}
                className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#3a4f5a] to-[#2a3f4a] text-white/50 hover:from-[#4a5f6a] hover:to-[#3a4f5a] border border-white/10"
              />
            </div>
          </div>
        </div>
