...
const GuideCard = ({ 
  title,
  duration,
  iconType = 'play', // 'play' | 'wallet' | 'qr' | 'ticket'
  onPlay,
  className = ""
}) => {
  const getIcon = () => {
  ...
  return (
    <button
      onClick={onPlay}
      className={`w-full bg-black/30 rounded-2xl p-4 border border-white/10 hover:border-yellow-500/30 transition-all ${className}`}
    >
