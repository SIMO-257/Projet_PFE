...
export default defineConfig({
  ...
  'Content-Security-Policy': "default-src 'self'; base-uri 'self'; form-action 'self'; object-src 'none'; media-src 'self' blob:; script-src 'self' https://js.stripe.com 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' * data: blob:; font-src 'self' data:; connect-src 'self' http://localhost https://api.stripe.com; frame-src 'self' https://js.stripe.com;",
  },
