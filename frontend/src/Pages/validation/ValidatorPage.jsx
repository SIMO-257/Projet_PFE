    ...
    <div className="app-shell">
      ...
      {result && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm" onClick={dismissResult}>
          <div
            className="relative w-full max-w-sm rounded-3xl overflow-hidden border border-white/10 backdrop-blur-lg shadow-2xl bg-gradient-to-br from-[#400106]/95 to-[#260101]/95 animate-fade-in"
          ...
          >
            ...
            <div className="p-6 text-center">
              {/* Status Icon — only this is green/red */}
              ...
              {/* Status heading — only text color green/red */}
              ...
              {/* Details — app palette, not colored */}
