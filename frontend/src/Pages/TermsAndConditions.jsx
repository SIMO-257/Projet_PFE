...
export default function TermsAndConditions() {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm font-sora">
            <div className="relative w-full max-w-2xl bg-gradient-to-br from-[#400106] to-[#260101] rounded-[2rem] shadow-2xl overflow-hidden border border-[#f5d579]/20 flex flex-col max-h-[90vh]">
                
                {/* Header */}
                <div className="p-6 md:p-8 border-b border-[#f5d579]/10 bg-black/10">
                ...
                <div 
                    ref={scrollRef}
                    className="flex-1 overflow-y-auto p-6 md:p-8 space-y-10 scroll-smooth"
                >
                    <style>{`
                ...
                {/* Footer */}
                <div className="p-6 md:p-8 border-t border-[#f5d579]/10 bg-black/10">
                    <div className="mb-6">
                        <label 
