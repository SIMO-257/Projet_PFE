...
const CheckoutForm = ({ amount, onSuccess, onCancel, isCancelling = false }) => {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex flex-col space-y-3 pt-2">
        <button
          ...
          disabled={!stripe || processing || isCancelling}
        ...
        <button
          type="button"
          onClick={onCancel}
          disabled={processing || isCancelling}
          className="w-full py-3 rounded-xl text-white/40 text-xs font-medium hover:text-white/60 transition-colors flex items-center justify-center space-x-2"
        >
          {isCancelling ? (
            <>
            ...
            <span>Annuler et modifier le montant</span>
          )}
        </button>
      </div>
    </form>
