...
const Notification = ({ 
    ...
    return (
        <div className={`fixed top-4 left-4 right-4 z-50 ${getBgColor()} text-white rounded-2xl p-4 shadow-lg flex items-center space-x-3 animate-slide-down ${className}`}>
